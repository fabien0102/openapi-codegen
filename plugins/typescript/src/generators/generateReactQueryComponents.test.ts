...
describe("generateReactQueryComponents", () => {
  ...
  it("should generate a useQuery wrapper (with pathParams)", async () => {
    ...
    expect(writeFile.mock.calls[0][1]).toMatchInlineSnapshot(`
      ...
      export const useSuspenseShowPetById = <TData = ShowPetByIdResponse,>(
        variables: ShowPetByIdVariables,
        options?: Omit<
          reactQuery.UseQueryOptions<ShowPetByIdResponse, ShowPetByIdError, TData>,
          "queryKey" | "queryFn" | "initialData"
        >,
      ) => {
        const { queryOptions, fetcherOptions } = usePetstoreContext(options);
  ...
  it("should generate useMutation for POST operation", async () => {
    ...
    expect(writeFile.mock.calls[0][1]).toMatchInlineSnapshot(`
      ...
      export const fetchAddPet = (variables: AddPetVariables, signal?: AbortSignal) =>
        petstoreFetch<string, AddPetError, AddPetRequestBody, {}, {}, {}>({
          url: "/pet",
          method: "post",
          ...variables,
          signal,
      ...
      export const useAddPet = (
        options?: Omit<
          reactQuery.UseMutationOptions<string, AddPetError, AddPetVariables>,
          "mutationFn"
        >,
      ) => {
        ...
        return reactQuery.useMutation<string, AddPetError, AddPetVariables>({
          mutationFn: (variables: AddPetVariables) =>
            fetchAddPet(deepMerge(fetcherOptions, variables)),
          ...options,
        });
      };
  ...
  it("should generate useQuery if openapi-codegen-component is defined", async () => {
    const writeFile = createWriteFileMock();
    const openAPIDocument: OpenAPIObject = {
      openapi: "3.0.0",
      info: {
      ...
      paths: {
        "/pet": {
          post: {
            operationId: "getPet",
            "x-openapi-codegen-component": "useQuery",
            requestBody: {
              content: {
                "application/json": {
                  schema: {
    ...
    expect(writeFile.mock.calls[0][1]).toMatchInlineSnapshot(`
      ...
      export type GetPetError = Fetcher.ErrorWrapper<{
        status: 500;
        payload: {
          code: 500;
          message: string;
      ...
      export const fetchGetPet = (variables: GetPetVariables, signal?: AbortSignal) =>
        petstoreFetch<string, GetPetError, GetPetRequestBody, {}, {}, {}>({
          url: "/pet",
          method: "post",
          ...variables,
          signal,
      ...
      export function getPetQuery(variables: GetPetVariables): {
        queryKey: reactQuery.QueryKey;
        queryFn: (options: QueryFnOptions) => Promise<string>;
      };

      export function getPetQuery(
        variables: GetPetVariables | reactQuery.SkipToken,
      ): {
        queryKey: reactQuery.QueryKey;
        queryFn:
      ...
      export function getPetQuery(variables: GetPetVariables | reactQuery.SkipToken) {
        return {
          ...
          queryFn:
            variables === reactQuery.skipToken
              ? reactQuery.skipToken
              : ({ signal }: QueryFnOptions) => fetchGetPet(variables, signal),
        };
      }

      export const useSuspenseGetPet = <TData = string,>(
        variables: GetPetVariables,
        options?: Omit<
          reactQuery.UseQueryOptions<string, GetPetError, TData>,
          "queryKey" | "queryFn" | "initialData"
        >,
      ) => {
        const { queryOptions, fetcherOptions } = usePetstoreContext(options);
        return reactQuery.useSuspenseQuery<string, GetPetError, TData>({
      ...
      export const useGetPet = <TData = string,>(
        variables: GetPetVariables | reactQuery.SkipToken,
        options?: Omit<
          reactQuery.UseQueryOptions<string, GetPetError, TData>,
          "queryKey" | "queryFn" | "initialData"
  ...
  it("should resolve requestBody ref", async () => {
    ...
    expect(writeFile.mock.calls[0][1]).toMatchInlineSnapshot(`
      ...
      export const fetchAddPet = (variables: AddPetVariables, signal?: AbortSignal) =>
        petstoreFetch<string, AddPetError, RequestBodies.Dog, {}, {}, {}>({
          url: "/pet",
          method: "post",
          ...variables,
          signal,
    ...
    expect(writeFile.mock.calls[0][1]).toMatchInlineSnapshot(`
      ...
      export const fetchUpdatePet = (
        ...
        petstoreFetch<
          string,
          UpdatePetError,
          RequestBodies.UpdatePetRequestBody,
          {},
          {},
          UpdatePetPathParams
        >({ url: "/pet/{petId}", method: "put", ...variables, signal });

      export const useUpdatePet = (
        options?: Omit<
          reactQuery.UseMutationOptions<string, UpdatePetError, UpdatePetVariables>,
          "mutationFn"
        >,
      ) => {
        const { fetcherOptions } = usePetstoreContext();
        return reactQuery.useMutation<string, UpdatePetError, UpdatePetVariables>({
          mutationFn: (variables: UpdatePetVariables) =>
            fetchUpdatePet(deepMerge(fetcherOptions, variables)),
          ...options,
        });
      };
