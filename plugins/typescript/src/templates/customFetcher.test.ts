...
describe("customFetcher", () => {
  it("should render the customFetcher", () => {
    ...
    expect(
      ...
      export default async function testFetch<TData, TBody extends {} | undefined | null, THeaders extends {} | undefined | null, TQueryParams extends {} | undefined, TPathParams extends {} | undefined>({ url, method, body, headers, pathParams, queryParams }: TestFetcherOptions<TBody, THeaders, TQueryParams, TPathParams>): Promise<TData> {
